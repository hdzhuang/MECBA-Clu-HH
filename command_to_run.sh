...
java -Xms2048m -classpath dist/MECBA-Clu-HH.jar jmetal.experiments.Experiment_PAES_2obj > resultado/time_Experiment_PAES_2obj.txt &
...
java -Xms2048m -classpath dist/MECBA-Clu-HH.jar jmetal.experiments.Experiment_PAES_4obj > resultado/time_Experiment_PAES_4obj.txt &
